				...
				<div class="col-lg-12">
					<div class="title-box">
						<form action="php/DatasUser.php" id="form" method="POST">
							<input id="nombreU" name="nombreU" type="text" placeholder="NOMBRE" required>
							...
							<input id="estadoN" name="estadoN" type="text" placeholder="estado de nacimiento" required>
							<input id="curp" name="curp" type="text" placeholder="curp" required>
