 	 ...
 	 <div class="form-container">
    	<h2>Ajustes <?php echo $_SESSION['user']?></h2>
      		...
      		<form  action="php/NewPass.php" method="POST">
            	...
            	<br>
            	<input class="btn" name="passA" type="password" placeholder="Nueva Contraseña" require>    
            	<br>
				<input class="btn" type="submit" name="enviar" value="cambiar">
			</form>
	...
	<div id="ahorro" class="gallery-box" style="background: #f7f7f7;"> 
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<a href=""><h2>Ahorro Descripcion</h2></a>
					</div>
				</div>
			</div>
		</div>
